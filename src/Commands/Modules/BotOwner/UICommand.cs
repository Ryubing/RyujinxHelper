...
public sealed partial class BotOwnerModule
{
    ...
    public Task<ActionResult> UiAsync([Description("Desired font size of the UI.")] int fontSize = 14)
    {
        return VolteBot.TryCreateUi(Context.Services, fontSize, out var errorReason)
            ? None(() => Context.Message.AddReactionAsync(DiscordHelper.BallotBoxWithCheck.ToEmoji())) 
